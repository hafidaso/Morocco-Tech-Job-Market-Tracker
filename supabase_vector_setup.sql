...
-- 4. Drop the function if it exists (to allow changing return type)
-- IMPORTANT: You MUST drop the function first before recreating it with a different return type
